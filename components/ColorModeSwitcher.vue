<template>
  <div>
    <ClientOnly>
      <button class="text-black" v-show="$colorMode.preference === 'light'" @click="$colorMode.preference = 'dark'">
        <Icon name="material-symbols:nightlight-outline" class="text-black text-6xl" />
      </button>
      <button class="text-white" v-show="$colorMode.preference === 'dark'" @click="$colorMode.preference = 'light'">
